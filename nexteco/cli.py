...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="nexteco", description="Repository-native cost-of-running tooling")
    ...
    validate_parser = subparsers.add_parser("validate", help="Validate a cost model YAML file")
    validate_parser.add_argument("input")
    validate_parser.set_defaults(func=cmd_validate)

    render_parser = subparsers.add_parser("render", help="Render Markdown from a cost model YAML file")
